...
from trading_rag.resilience import CircuitBreaker
...
class ElasticsearchClient:
    ...
    def get_execution_logs_index(self) -> str:
        return settings.elasticsearch.execution_logs_index

    def get_feed_logs_index(self) -> str:
        return settings.elasticsearch.feed_logs_index

    def get_incidents_index(self) -> str:
        return settings.elasticsearch.incidents_index
